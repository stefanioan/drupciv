...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal_user:VxJm3CezjItc9cOtuM5T@localhost/drupal_db?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm_user:9SYl9NZtLSHrlsHQ2Ju4@localhost:3306/civicrm_db?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
 define( 'CIVICRM_UF_BASEURL'      , 'http://host1.sitecaretaker.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '0a8081c774db964df4b4642ab300efc2');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/stefan2/civicrm.sitecaretaker.com/sites/default/files/civicrm/templates_c//mail.log');
// }
